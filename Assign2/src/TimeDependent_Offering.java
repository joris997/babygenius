...
public class TimeDependent_Offering extends OfferingStrategy {
	...
	public BidDetails determineNextBid() {
		...
		System.out.println("next bid (our util): " + nextBid.getMyUndiscountedUtil());
		System.out.println("next bid (opponent util): " + opponentModel.getBidEvaluation(nextBid.getBid()));
		return nextBid;
	}
